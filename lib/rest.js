 ...
 */
 var createAndStartCollaboratingProcessRoute = '/api/v1/process/bpmnCollaborate';
 ...
 */
var createProcessRoute = '/api/v1/process/:processName';
 ...
 */
var createAndStartProcessRoute = '/api/v1/process/:processName/:startEventName';
 ...
 */
var getProcessRoute = '/api/v1/process/:processName/:id';
 ...
 * @apiParam {String} processName Name of the process as used in the BPMN model
 */
var getProcessesRoute = '/api/v1/process/:processName';
 ...
 *
 */
var sendMessageRoute = '/api/v1/process/:processName/:id/:messageName/:messageId';
...
exports.createServer = function(manager, options, restifyOptions) {
    ...
    server.on('after', function( request, response, route, error) {
        try{
            var handler = settings.onServerAfterEvent || onServerAfterEvent;
